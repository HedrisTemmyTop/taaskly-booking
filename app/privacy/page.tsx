  ...
  return (
    <ResponsiveWrapper>
      ...
      <div>
        ...
        <div>
          For more information on the privacy practices of Fathom, please visit
          the Fathom Privacy Terms web page: https://usefathom.com/terms Twipla
          Analytics
        </div>
        ...
        <div>
          ...
          behavior analytics, and communication tools. It aims to offer precise
          and instant insights into website performance with features such as
          website statistics, session replays, heatmaps, polls, and surveys.
        </div>
        <div>
          Designed to be privacy-perfect and intuitive, TWIPLA is used by a wide
          range of clients, from startups to giant corporations across over 180
          countries, ensuring GDPR/CCPA compliance without the use of cookies or
          fingerprinting. The platform also includes options for white labeling,
          making it suitable for SaaS platforms and agencies looking to offer
        ...
        <div>
          For visitors outside of the European union, we use Google Analytics as
          a third-party tracking service, but we don’t use it to track you
          ...
          how our users, in general, navigate through and use Taaskly.site. This
          helps us evaluate our users use of Taaskly.site, compile statistical
          reports on activity, and improve our content and website performance.
        </div>
        <div>
        ...
        <div>
          ...
          notified about upcoming bookings. These emails and SMS are sent using
          our service provider Twilio. You agree that we may share your mobile
          phone number and the contents of any message you send or receive
          through such Service with our third-party partner, Twilio. For more
          information regarding how Twilio may store or use your information,
          please review Twilio&apos;s Privacy Policy which can be found here:
