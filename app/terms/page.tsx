...
export default function Page() {
  return (
    <ResponsiveWrapper>
      ...
      <div>
        <div className="mb-10">Effective date: 06/07/2024</div>
        <div>
          Welcome to Taaskly.site (“Company”, “we”, “our”, “us”)! As you have
        ...
        <div>
          ...
          of our web pages located at https://taaskly.site operated by
          Taaskly.site.
        </div>
        <div>
        ...
        <div>
          ...
          support@taaskly.site so we can try to find a solution. These Terms
        ...
        <div>
          ...
          Taaskly.site cancels it. You may cancel your Subscription renewal
          either through your online account management page or by contacting
          Taaskly.site customer support team.
        </div>
        <div>
          ...
          Taaskly.site with accurate and complete billing information including
          ...
          you automatically authorize Taaskly.site to charge all Subscription
          fees incurred through your account to any such payment instruments.
        </div>
        <div>
          Should automatic billing fail to occur for any reason, Taaskly.site
        ...
        <div className="mt-10">
          Taaskly.site may, at its sole discretion, offer a Subscription with a
        ...
        <div>
          ...
          Trial, you will not be charged by Taaskly.site until Free Trial has
        ...
        <div>
          At any time and without notice, Taaskly.site reserves the right to (i)
          modify Terms of Service of Free Trial offer, or (ii) cancel such Free
          Trial offer.
        </div>
        <div className="mt-10">
          Taaskly.site, in its sole discretion and at any time, may modify
        ...
        <div>
          Taaskly.site will provide you with a reasonable prior notice of any
        ...
        <div>
          Taaskly.site has the right but not the obligation to monitor and edit
          all Content provided by users. In addition, Content found on or
          through this Service are the property of Taaskly.site or used with
        ...
        <div>Take any action that may damage or falsify Company rating.</div>
        <div>
        ...
        <div className="my-10">
          ...
          property of Taaskly.site and its licensors. Service is protected by
          ...
          product or service without the prior written consent of Taaskly.site.
        </div>
        <div>
        ...
        <div>
          ...
          to support@taaskly.site, with the subject line: “Copyright
        ...
        <div>
          You can contact our Copyright Agent via email at support@taaskly.site
        </div>
        <div className="mt-10">
          You may provide us either directly at support@taaskly.site or via
        ...
        <div>
          ...
          https://sentry.io/privacy/ Raygun is automated error monitoring
        ...
        <div className="mt-10">
          ...
          that are not owned or controlled by Taaskly.site.
        </div>
        <div>
          Taaskly.site has no control over, and assumes no responsibility for
          the content, privacy policies, or practices of any third party web
          sites or services. We do not warrant the offerings of any of these
          entities/individuals or their websites.
        </div>
        <div>
          YOU ACKNOWLEDGE AND AGREE THAT TAASKLY.SITE SHALL NOT BE RESPONSIBLE
